...
public class BinaryTree implements Serializable {
	...
	private int numLeavesHelper(Node n){	
		if(n.left == null && n.right == null){
			return 1;
			
		}
		return numLeavesHelper(n.left) + numLeavesHelper(n.right);
	}
	private int numNodesWithOneChildHelper(Node n){
		if(n == null)
			return 0;
		if(n.left == null && n.right != null){
			return 1 + numNodesWithOneChildHelper(n.right);
		}
		if(n.left != null && n.right == null){
			return 1 + numNodesWithOneChildHelper(n.left);
		}
		return numNodesWithOneChildHelper(n.left) + numNodesWithOneChildHelper(n.right);
	}
	public int numNodesWithOneChild(){
		return numNodesWithOneChildHelper(root);
	}
	...
	private void swapChildrenHelper(Node n){
		if(n!=null){
			...
			n.left = n.right;
			n.right = temp;
			swapChildrenHelper(n.left);
			swapChildrenHelper(n.right);
		}
	}
